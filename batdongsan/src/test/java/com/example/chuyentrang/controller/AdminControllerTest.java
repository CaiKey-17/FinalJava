...
import com.example.chuyentrang.controller.AdminController;
import com.example.chuyentrang.model.Available;
import com.example.chuyentrang.model.User;
import com.example.chuyentrang.service.AvailableService;
import com.example.chuyentrang.service.UserService;
import com.example.chuyentrang.service.PackageService;
...
class AdminControllerTest {
    ...
    void testManagerPackage() throws Exception {
        when(userService.getName("caoky")).thenReturn("Admin User");
        when(packageService.getAllPackage()).thenReturn(List.of(new com.example.chuyentrang.model.Package(), new com.example.chuyentrang.model.Package()));
